...
the recording has been administrated for each participant in a dark room. Each subject has been seated on a comfortable chair faced with a **43 inch screen**.

The screen was set to standard color mode with normal brightness and contrast. The distance between the subjects and the screen was **125 centimeters**.
Adequate information had been provided for each subject before recording any session, i.e. how many sessions would occur during recording brain signals, and how many times the color and the shapes would be presented.

After installing and configuring the EEG device on the subject’s head, the signal
...
![Figure 2.](https://github.com/Zhyiar/Univsul-Dataset/blob/master/PNG/DataPreparation_FlowChart.png)

Figure (3) presents CNN architecture.
 
![Figure 3.](https://github.com/Zhyiar/Univsul-Dataset/blob/master/PNG/standard_cnn_correction.png)

Figure (4) presents the architecture of the proposed model (in the paper), all modifications in the model are enclosed with blued dashed border.

![Figure 4.](https://github.com/Zhyiar/Univsul-Dataset/blob/master/PNG/Second_Proposed_Model_Correction_U.png).

Figure (5) The architecture of the second proposed model has been presented in (Figure 5).

![Figure 5.](https://github.com/Zhyiar/Univsul-Dataset/blob/master/PNG/First_Proposed_Model_After_Correction_3.png).
  
Figure (6) shows a comparison table between the CNN, hybrid CNN and ALPS-GA, combined CNN and Coiflet 1 with SGD, and combined CNN and Symlet 2 with SGD.
  
![Figure 6. ](https://github.com/Zhyiar/Univsul-Dataset/blob/master/PNG/Final_comp.png).
